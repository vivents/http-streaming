...
export default class SegmentLoader extends videojs.EventTarget {
  constructor(settings, options = {}) {
    ...
    this.experimentalExactManifestTimings =
      settings.experimentalExactManifestTimings;
  ...
  playlist(newPlaylist, options = {}) {
    ...
    if (segmentInfo) {
      ...
      if (segmentInfo.mediaIndex < 0) {
        ...
        if (segmentInfo.mediaIndex >= 0 && segmentInfo.segment) {
  ...
  addSegmentMetadataCue_(segmentInfo) {
    if (!this.segmentMetadataTrack_ || !segmentInfo.segment) {
      return;
    }
